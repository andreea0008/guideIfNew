...
Company::Company(int id, const QString &nameCompany, const QStringList &phonesCompany, const QStringList &schedule, const QString &addressCompany, const QString &description, QObject *parent) :
