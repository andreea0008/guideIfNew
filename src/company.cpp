...
Company::Company(int id, const QString &nameCompany, const QString &addressCompany, const QString &hourFrom,
                 const QString &hourTo, const QString &specialization, const QString &description, QObject *parent) :
    QObject(parent), m_id(id), m_company(nameCompany), m_address(addressCompany), m_hourFrom(hourFrom),
